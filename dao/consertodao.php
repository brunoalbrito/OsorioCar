...
class ConsertoDao
{
	...
	public static function adicionarConserto($conserto,$idcarro){

		include 'conexao.php';
		echo '</br>Chamando adicionarConserto';

		echo '</br> ID CARRO: '.$idcarro;
		echo "</br>".$conserto->data." ".$conserto->valorPecas." ".$conserto->pecasUtilizadas." ".$conserto->valorTotal;


		$resultado = mysqli_query($conexao,
			"INSERT INTO conserto(fk_id_carro,dataRegistro,valor_peca,pecas_utilizadas,descricao,valorMaoObra,valor_total)VALUES
			('".$idcarro."','".$conserto->data."','".$conserto->valorPecas."','".$conserto->pecasUtilizadas."'
